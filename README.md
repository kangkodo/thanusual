...
지도 레이어(동네 생활인구, 지하철 승하차, 따릉이·도로 통제, 오늘 행사)도 같은 서울 인증키로 `data` 브랜치에 올립니다. 동네는 4~11일 전 하루치를 3시간 단위로 받아 지금 시간대에 가까운 것을 그리고, 동네·지하철은 잉크색 농도로만 그려 붐빔 주황과 겹치지 않게 합니다. 실시간 칸 혼잡·50m 격자는 무료 공개가 아니라 넣지 않습니다.
